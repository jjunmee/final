...
public class AlarmVo {
	...
	public AlarmVo() {}
	//전체 생성자
	public AlarmVo(int alarm_num, String alarm_content, Date alarm_date,int content_num, int au_num, int alarm_state, int profile_num) {
	...
	//알람
	public AlarmVo(int alarm_num, String alarm_content, Date alarm_date,int content_num) {
		this.alarm_num = alarm_num;
		this.alarm_content = alarm_content;
		this.alarm_date = alarm_date;
	...
	public AlarmVo(int au_num, String alarm_content,int content_num, int alarm_state) {
		this.au_num = au_num;
		this.alarm_content = alarm_content;
		this.content_num=content_num;
		this.alarm_state = alarm_state;
