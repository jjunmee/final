...
public class Comment_bookmarkVo {
	...
	public Comment_bookmarkVo() {
	}
	public Comment_bookmarkVo(int comment_num, String comment, int c_lev, int c_step, int content_num, int profile_num,
			boolean comment_open, boolean bookmark, int bookmark_time) {
